...
{
    /**
     * @param JobParameters $job_parameters Job parameters should contain the file_path where the file was uploaded to
    ...
    protected function _get_where_txn_where_conditions(): array
    {
        // send to texact IDs
        // return array(
        //     'TXN_ID' => array('IN',
     ...
     * @throws EE_Error
     */
    protected function send_ticket_notice(EE_Transaction $transaction): bool
    {
